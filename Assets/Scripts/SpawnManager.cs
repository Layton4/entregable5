...
public class SpawnManager : MonoBehaviour
{
    ...
    void Start()
    {
        InvokeRepeating("SpawnObstacle", TimeFirstSpawn, TimeSpawn); //Ejecutamos la función spawnobstacle a los 0.5 segundos de darle a play, se vuelve a ejecutar cada 5 segundos.
    }
